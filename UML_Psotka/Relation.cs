...
namespace UML_Psotka
{
    public class Relation
    {
        ...
        public void DrawBetweenClasess(Graphics g, int xM, int yM)
        {
            ...
            {
                g.DrawLine(pen, FirstClass.X, FirstClass.Y + FirstClass.Height / 2, SecondClass.X + SecondClass.Width / 2, FirstClass.Y + FirstClass.Height / 2);
                g.DrawLine(pen, SecondClass.X + SecondClass.Width / 2, FirstClass.Y + FirstClass.Height / 2, SecondClass.X + SecondClass.Width / 2, SecondClass.Y + SecondClass.Height / 2);
                this.DrawType(g, direction.RIGHT, FirstClass);
            }
            else if (SecondClass.X > FirstClass.X)
            {
                g.DrawLine(pen, FirstClass.X + FirstClass.Width, FirstClass.Y + FirstClass.Height / 2, SecondClass.X + SecondClass.Width / 2, FirstClass.Y + FirstClass.Height / 2);
                g.DrawLine(pen, SecondClass.X + SecondClass.Width / 2, FirstClass.Y + FirstClass.Height / 2, SecondClass.X + SecondClass.Width / 2, SecondClass.Y + SecondClass.Height / 2);
                this.DrawType(g, direction.LEFT, FirstClass);
            }
        }
